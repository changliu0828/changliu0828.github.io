...
{{< figure src="/image/libco-coroutine/callback-hell.svg" width="50%" caption="图2. 同步与异步编程下的代码片段">}}
...
{{< figure src="/image/libco-coroutine/function-call-example.svg" width="60%" caption="图3. sum.cpp函数栈">}}
...
{{< figure src="/image/libco-coroutine/co_make.svg" width="60%" caption="图4. co_make初始化协程栈">}}
...
{{< figure src="/image/libco-coroutine/coctx_swap.svg" width="90%" caption="图5. coctx_swap上下文切换">}}
