...
<section class="canvas-container">
  ...
  <section class="control">
    ...
    <div class="control-label-value">
      ...
      <div class="control-input-group">
        <input type="range" id="separation" class="control-input" min="0" max="100" step="1" value="0">
    ...
    <div class="control-label-value">
      ...
      <div class="control-input-group">
        <input type="range" id="cohesion" class="control-input" min="0" max="100" step="1" value="0">
    ...
    <div class="control-label-value">
      ...
      <div class="control-input-group">
        <input type="range" id="alignment" class="control-input" min="0" max="100" step="1" value="0">
